            ...
            <div id="fulfillment" class="tabcontent">
                ...
                <div class="postbox" style="padding: 10px;margin-top: 10px;">
                    ...
                    <script>
                        ...
                        if (window.location.host == 'loxloaded.com' || window.location.host == 'riflenetics.com' || window.location.host == 'urbanrifleworks.com' || window.location.host == 'garidium.com' || window.location.host == 'localhost:8000'){
