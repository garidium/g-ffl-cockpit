                    ...
                    <form method="post" action="options.php" onSubmit="return setConfig('<?php echo esc_attr($gFFLCockpitKey);?>');">
                        ...
                        <tr>
                            ...
                            <tr valign="top">
                                ...
                                <script>
                                    var all_brands = ["10 Ring Marketing / WRJ", "10 RING MKTG / WRJ LLC", "1791", "1791 GUNLEATHER", "2 Monkey Trading", "2 Monkey Trading llc.", "2A Armament", "30-06 Outdoors", "3M Peltor", "3M/Peltor", "A-Zoom", "Accu-Tac", "ACCUFIRE TECHNOLOGY INC", "Accurate", "Accusharp", "ACE", "Action Target", "ACTION TARGET INC", "Adams Arms", "ADAPTIVE TACTICAL", "ADCO", "ADCo International", "Advance Warrior Solutions", "ADVANCED ARMAMENT COMPANY", "Advanced Armament Corp", "Advanced Tech", "Advanced Technology", "Advantage Arms", "Adventure Medical Kits", "Aero Precision", "AeroPrecision", "After Bite", "AGM Global Vision", "Aguila", "Aguila Ammunition", "Aim Sports", "AimCam", "AimShot", "Aimtech", "Akkar", "Alex Pro Firearms", "Alexander Arms", "ALG Defense", "Alien gear", "Alien Gear Holsters", "Allen", "ALLIANCE CONSUMER GROUP", "Alliant", "Altus Brands", "AMAC (American Militray Arms Corp)", "Amend2", "American Buffalo Knife & Tool", "American Built Arms Company", "American Classic", "American Defense", "American Defense Mfg", "American Hunter", "AMERICAN PRECISION ARMS", "American Tactical / ATI", "Ameriglo", "Ammo Inc", "AMMO INCORPORATED", "Ammunition Storage Components", "AMS Bowfishing", "Anderson Manufacturing", "Andro Corp Industries", "Angstadt Arms", "Ani-Logics Outdoors", "Anschutz", "Antler King", "APEX TACTICAL SPECIALTIES", "Aquamira", "Ar-mor", "ARB", "Archangel", "Arctic Ice", "Arctic Shield", "Arex", "Arisaka Defense", "ARMA ZEKA", "Armalite", "Armasight", "ARMASIGHT (THIRD BULL)", "Armaspec", "Armsco", "Armscor/Rock Island Armory", "Arsenal Firearms", "Arsenal, Inc.", "ATA Arms", "ATA SHOTGUNS/FOXTROT LLC", "Athlon", "ATI Outdoors", "ATN", "Atomic", "Atomic Ammunition", "Atsko", "Auto Ordnance", "Auto-Ordnance", "Avian X", "AVIAN X (GSM)", "Axcel", "Axe", "Axe Crossbows", "Axeon", "AXON/TASER (LC PRODUCTS)", "B&T FIREARMS", "B&T Weapons", "B3 Archery", "B5 Systems", "Backup Tactical", "Ballistic Adv", "Ballistic Advantage", "BAREBONE OUTDOORS FLASHLT", "Barnaul Ammunition", "Barnes", "Barnes Bullets", "Barrett Firearms", "Barska", "Bastion", "Battenfeld", "Battle Arms Development", "Bayco", "Bear & Son", "Bear Archery", "Bear Edge", "Bear Ops", "Beartooth Products", "BECK TEK, LLC (TEKMAT)", "Bee Stinger", "Beeman", "Benchmaster", "Benjamin", "Benjamin Sheridan", "Beretta", "Beretta Air Pistol", "Beretta USA", "Bergara", "Berger Bullets", "Berrys", "Bersa", "Bianchi", "Big Bobber", "Big Sky Racks", "Bino Dock", "Birchwood Casey", "Black Aces Tactical", "BLACK HILLS AMMUNITION", "Black Rain", "Black Rain Ordnance", "Black Rain Ordnance Inc", "Black Spider LLC", "BLACKHAWK", "Blackhorn", "BlackPoint", "BlackPoint Tactical", "Blaser USA", "Blazer Ammunition", "Block Targets", "Blue Book", "Blue Book Publications", "Blue Force Gear", "Blue Line Diana", "BLUE LINE GLOBAL", "Bob Allen", "Bog", "Bog-Pod", "Bohning", "Bond Arms", "BoneView", "Bootleg", "Bore Tech", "BoreSnake", "Bounty Hunter", "BOWDEN TACTICAL", "Boyt Harness", "Bravo", "Bravo Company Mfg / BCM", "Bravo Concealment", "Break Free", "Break-Free", "BreakFree", "Breakthrough Clean", "Breakthrough Clean Technologies", "Breakthrough cleaning", "Breda/Dickinson", "Brenneke", "Brigade Firearms", "Brigade Mfg.", "BRNO", "Browning", "Browning Ammo", "Browning Trail Cameras", "BSA", "BSA Optics", "Bubba Blade", "BUBBA BLADE/BATTENFIELD", "Bubba Rope", "Buck Bomb", "Buck Wear", "Buffalo Bore Ammunition", "Buffalo Cartridge Company", "BUL ARMORY USA", "Bull Frog", "Bulldog", "Bulldog Cases", "BulletSafe", "Burris", "Bushmaster", "Bushnell", "Butchs", "Butler Creek", "BUY GUNS LLC/BIRD DOG ARM", "BYRNA TECHNOLOGIES", "C Products Defense", "C-More Systems", "C&G HOLSTERS", "C&H Precision Weapons", "CAA", "Cajun Bowfishing", "Caldwell", "Camelbak", "Cameleon", "Camo Unlimited", "CANIK", "CANYON ARMS,LLC", "Carbon Express", "Carlson", "Carlsons", "Case", "Cass Creek", "CCI", "CenterPoint", "Century Arms", "CGS SUPPRESSORS", "Champion", "Champion Targets", "Champion Traps & Targets", "Chaos Gear Supply", "Charles Daly", "Charles Daly Chiappa", "Charter Arms", "CHEYTAC (CAMPBELL ARMS)", "Cheytac USA", "Chiappa Firearms", "CHILD GUARD", "Chip McCormick Custom", "Chipmunk", "Christensen Arms", "Cimarron Firearms", "Citadel", "CIVIVI", "CLEAN CONTROL/LETHAL PROD", "Cleanshot", "Clenzoil", "Cloud Defensive", "CLOUD DEFENSIVE LLC", "CMC Products", "CMC Triggers", "CMMG", "Cobra Archery", "COBRA PISTOL/BEARMAN IND", "COBRA TEC KNIVES LLC", "Cobratec Knives", "Code Blue", "Cold Steel", "Cole-TAC", "Coleman", "Colt", "Colt Air Pistol", "Colt Mfg", "Colt Rimfire", "Columbia River", "Columbia River Knife & Tool", "Command Arms", "Comp-Tac", "Connecticut Valley Arms / CVA", "ConQuest", "Cor-Bon", "CorBon", "CORROSION TECHNOLOGIES", "Counter Assault", "Covert Camera's", "Covert Scouting Cameras", "CRANFORD MFG.", "Crimson Trace", "Crimson Trace Corporation", "CRKT Knives", "Crosman", "Cross Armory", "Cross Industries", "Crossfire", "Crucial Concealment", "Cruxord", "Cuddeback", "Custom Bow Equipment", "CVA MASS MARKET", "Cyclops", "CZ-USA", "D-Lead", "D.T. Systems", "D&H Tactical", "DAC", "Daisy", "Dan Wesson", "Daniel Defense", "Davey Crickett", "DDUPLEKS USA INC", "Dead Air", "Dead Air Armament", "Dead Air Silencers", "Dead Down Wind", "DEAD DOWN WIND (ARCUS)", "Dead Foot", "Del-Ton", "Del-Ton Inc", "DeSantis", "DeSantis Gunhide", "Desert Tech", "Diamondback", "Diamondback Barrels", "Diamondback Firearms", "DIAMONDBACK KNIFEWORKS", "Diamondhead USA Inc.", "DNZ", "DNZ Products", "Do All Traps", "Double Take Archery", "DoubleStar", "DoubleTap Ammunition", "DPMS", "Drago Gear", "DRD Tactical", "Drymate", "Duck Commander", "Dura Sight", "DURAMAG", "E.M.F. Company Inc", "EAA", "Eagle Industries", "EAR", "Easton", "Ed Brown", "Edgar Sherman Design", "Element Outdoors", "Eley", "Elftmann Tactical", "Eliminator Spray", "Elite Tactical Systems Group", "Energizer", "EOTech", "Ergo", "Ergo Grip", "ESCA Tech", "Escort", "Estate", "ET Arms", "ET ARMS INC", "ETS Group", "European American Armory / EAA Corp", "Eva-Dry", "Evolution Gun Works", "Evolution Outdoor", "Excel", "Excel Arms", "Exothermic Technologies", "EZR Sport", "F-1 Firearms", "F.A.B. Defense", "FAB DEFENSE (USIQ)", "Fail Zero", "FailZero", "FAUSTI USA, INC", "Faxon Firearms", "Federal", "FENIX WHOLESALE", "FERADYNE INC", "FIERCE FIREARMS", "FightLite Industries", "FIME", "Fime Group", "Fiocchi", "Fiocchi Ammunition", "Firearm Safety Devices", "Firearm Safety Devices Corporation", "FIREBIRD USA", "Firefield", "Flambeau", "Flextone Calls", "Flextone Decoys", "FLIR", "Flitz", "Flitz International", "Flying Arrow Archery", "FMK", "FMK Firearms", "FN America / FN Herstal", "Fobus", "FORSTER PRODUCTS INC", "FORT SCOTT MUNITIONS", "Fortis Manufacturing, Inc.", "Fortune Products (Accusharp)", "FosTech Outdoors", "Fox Labs", "Foxpro", "Frankford Arsenal", "Franklin Armory", "Freedom Ordance", "Freedom Ordnance", "Frogg Toggs", "FrogLube", "FRONTIER", "Frontier Cartridge", "FSDC", "Full Forge Gear", "Fusion Firearms", "FUSION PRECISION", "G-SHOCK/VLC DISTRIBUTION", "G*Outdoors", "G2 Research", "G5 OUTDOORS", "G96", "G96 Products", "Galco", "Gamo", "Garaysar", "Garmin", "Gatco", "Geissele Automatics", "GERMAN PRECISION OPTICS", "German Sport Guns / GSG", "GForce Arms", "GG&G, Inc.", "Ghost Inc", "Ghost Inc.", "Gilboa/Silver Shadow", "Girls With Guns", "Girsan Firearms", "Glaser", "Glaser Ammunition", "GlenDel", "GLOBAL DEFENSE TRADE", "Glock", "Glock Air Pistol", "God'a Grip", "Gold Tip", "Golden Rod", "Gorilla", "Gorilla Ammunition Company LLC", "GPS", "Grace USA", "GREAT LAKES FIREARMS", "Great Lakes Firearms & Ammo", "Great Lakes Firearms & Ammunition", "Grey Ghost Gear", "Grey Ghost Precision", "Griffin Armament", "Grim Reaper", "Grip Pod", "GrovTec", "Grovtec US Inc", "GSG German Sports Guns", "Guard Dog", "Guard dog security", "Gun Storage Solutions", "GunMate", "Gunslick", "Guntec USA", "GunVault", "GUNWERKS LLC", "H&N Sport Pellets", "HABIT", "HALO (GSM)", "Halo Optics", "Hammerli", "Hamskea Archery", "Harris", "Harris Engineering", "Harvester", "Hatfield", "Hatsan Airguns", "Hatsan USA / Escort Shotguns", "Havalon", "Havalon Knives", "Hawk", "Haydel's", "Haydels", "Heckler & Koch / H&K", "Heizer Defense", "HELIX 6 (USIQ)", "Henry Repeating Arms", "Hera", "Hera USA", "Heritage Arms", "Heritage Mfg", "HEVI-METAL (VISTA)", "HEVI-Shot", "Hevishot", "HEXMAG", "HHA Sports", "Hi Point Firearms", "Hi-Viz", "HIGDON DECOYS", "High Mountain Defense Inc dba - Old West Firearms", "HIGH SPEED GEAR", "Hiperfire", "Hiviz", "HKS", "HME", "HME Products", "Hodgdon", "Hogue", "Holosun", "Holosun Technologies", "Homeland", "Honeywell Safety Products", "Hook's Custom Calls", "Hooyman", "Hoppe's", "Hoppes", "HORIZON DESIGN", "Hornady", "Hot Shot", "Hot Shot Archery", "HotHands", "Howa", "Howard Leight", "HSM", "HSM Ammo", "Humvee Accessories", "Hunter Company", "Hunter Safety System", "Hunter's Kloak", "Hunters Specialties", "Hurricane", "Huskemaw Optics", "HUXWRX Safety Company", "HYPERION MUNITIONS", "iHunt", "Impact Weapons Components", "Impala Plus", "IMR", "Industrial Revolution", "INFORCE", "Inland Manufacturing", "Inland Mfg", "Insights Hunting", "International Firearm Corporation", "IOTA (HORIZON FIREARMS)", "IQ Bowsight", "IRAY USA LLC", "IRAYUSA", "IRON CITY RIFLE WORKS", "Istanbul Silah", "Italian Firearms Group", "Iver Johnson", "IWI - Israel Weapon Industries", "IWI US", "IWI US (Israel Weapon Industries)", "J.P. Sauer & Sohn", "J&E Machine Tech", "Jacob Grey", "Johnny Stewart", "JTS Shotgun (XISICO USA)", "Just Right Carbine", "Just Right Carbines", "Ka-Bar", "Ka-Bar Knives", "KABAR", "Kahr Arms", "Kalashnikov USA", "KCI USA", "KCI USA Inc", "KE Arms", "Kel-tec", "KelTec", "Keng's", "Kent Cartridge", "Kershaw", "Kestrel", "Kestrel Ballistics", "Kick's Industries", "Kimber", "Kinetic Development Group, LLC", "KINGPORT INDUSTRIES LLC", "Kleen-Bore", "Knights Armament Company", "KNIGHTS MFG COMPANY", "KNS Precision", "KNS Precision, Inc.", "KOBAYASHI CONSUMER PROD", "Konus", "Koola Buck", "KOPFJAGER/SELLMARK", "Kriss TDI", "Kynshot", "L.A.G. Tactical, Inc.", "LAG TACTICAL INC", "Lancer", "Landor Arms", "LANGDON TACTICAL TECH", "Lansky Sharpeners", "Lantac USA", "Lapua", "Laserlyte", "LaserMax", "LBE Unlimited", "Leapers, Inc. - UTG", "Lee", "Lee Armory", "Legacy Sports International", "Leupold", "Liberty", "Liberty Ammunition", "Lightfield", "LIMBSAVER", "Live Free Armory", "LKCI", "Lockdown", "Lone Wolf Distributors", "LONGSHOT TARGET CAMERA", "Lucas Oil", "Lucid Optics", "Lumenok", "Luth-AR", "LUXUS ARMS (HM DEFENSE)", "LWRC", "Lyman", "M-PRO 7", "M-Pro7", "M&P Accessories", "M+M", "M+M Inc", "Mace", "Mace Security International", "Mag Storage Solutions", "maglula", "Maglula ltd.", "MagnetoSpeed", "Magnum Research", "Magnus Broadheads", "MagPod", "Magpul", "Magpul Industries", "MAGPUL INDUSTRIES CORP", "Magpump", "Magtech", "Manticore Arms", "Manticore Arms, Inc.", "Mantis", "Marksman", "Marlin", "Master Cutlery", "Master Lock", "MasterLock", "MasterPiece Arms", "Matrix Diversified Ind", "Mauser", "Maverick Arms", "Max Ops", "Max-Ops", "Maxim", "Maxim Defense Industries", "Maxpedition", "McCOY", "McCoy Shotguns", "MDT", "MDT SPORTING GOODS INC", "MEC", "MEC-GAR", "Mec-Gar Magazines", "Mecgar", "Mechanix Wear", "MEPRO USA LLC", "Meprolight", "Mesa Tactical", "META TACTICAL LLC", "Metalform Magazines", "Michaels", "MID-EVIL INDUSTRIES", "Midwest Industries", "MIDWEST INDUSTRIES INC", "MIGRA AMMUNITION", "Military Arms Corporation", "Millennium Marine", "Millennium Treestands", "Mission Archery", "Mission First Tactical", "MO TACTICAL PRODUCTS LLC", "Mobile Warming", "Modern Muzzleloader", "Moisture King", "Mojo", "MOJO OUTDOORS", "Montana Decoy Company", "Morakniv", "Morrell Targets", "Mossberg", "Moultrie", "Mountain Mike's", "Mountain Tactical", "Mr.Heater", "MTM", "Muddy", "Muzzy", "NAA", "NANUK (PLASTICASE INC)", "NAP", "Natrapel", "NCSTAR", "Nemo Arms", "New Archery Products", "Nexbelt", "Night Fision", "Nightstick", "Nine Line Apparel", "Nobelsport", "Nockturnal", "Nomad", "Nordic Components", "NORMA AMMUNITION (RUAG)", "North American Arms", "North American Rescue", "Northeast Products", "Nose Jammer", "Nosler", "Nosler Bullets", "Noveske Rifleworks", "NovX", "NXT Generation Toys", "OAKLEY (LUXOTTICA)", "OAKS WHOLESALE DIST/IVER", "Odin Works", "Old Timer", "Old West", "On Time", "OPSOL", "OPSol Texas", "Optical Dynamics", "OPTIMAX TECHNOLOGY LLC", "Orthos", "Otis", "Otis Technology", "Otto", "Outdoor Cap", "Outdoor Edge", "OUTDOOR PRODUCT INNOVATIO", "Outers", "Pachmayr", "Para Ordnance", "Pathfinder", "Patriot Ordnance Factory", "Peace Keeper", "Pearce Grip", "Pearce Grips Inc.", "Peet Dryer", "Pelican", "PepperBall", "Peregrine Outdoors", "Phase 5", "PHASE 5 WEAPON SYSTEMS", "PHOENIX ARMS", "Phoenix Technologies", "Phone Skope", "Pietta", "PIETTA (EMF COMPANY INC)", "Pine Ridge Archery", "PINEY MOUNTAIN AMMUNITION", "Pioneer", "PITBULL TACTICAL", "Pittman Game Calls", "Plano", "PMC", "Pointer", "Polymer 80 Inc", "PowerBelt Bullets", "PPU", "Predator Tactics", "PREDATOR TACTICS INC", "PREMIER BODY ARMOR LLC", "Primary Weapons", "Primary Weapons Systems", "Primos", "Pro Ears", "Pro Mag", "Pro-Shot", "Pro-Shot Products", "ProMag", "PROOF RESEARCH", "PRT", "Prvi Partizan", "PS Products", "PSE Archery", "PSP", "PSP Products", "PTR", "Pulsar", "Pulsar Thermal", "Pyramex", "Q LLC", "QAD", "Quake", "Quaker Boy", "QUIETKAT INC /VISTA OUTDO", "Radian Weapons", "Radians", "Radical Firearms", "RAGE", "Ramcat", "RamRodz", "Ramshot", "Ranch Products", "RANGER RUGGED GEAR", "RANGETRAY, LLC", "Rapid Force", "Rapid Rope", "RAPID ROPE LLC", "RapidPure", "Raven Concealment Systems", "Ravenwood International", "Ravin Crossbows", "Rayovac", "RCBS", "Real Avid", "Real Avid/Revo", "Realtree", "Reapr", "RECOVER INNOVATIONS INC", "Red Army Standard", "Red Rock Gear", "Redball Sports", "Redfield Mounts", "REFURBISH DENT SCRATCH", "REM ARMS LLC ACCESS", "REM ARMS LLC FIREARMS", "Remington", "Remington Accessories", "Remington Ammunition", "Remington Cutlery", "Reptilia", "REPTILLA,LLC", "Retay USA", "Rhino", "Rifle Basix", "RIG", "Riley Defense", "RILEY DEFENSE INC", "RIO AMMUNITION", "Rise Armament", "Riton", "Riton Optics", "Rival Arms", "Rivers Edge", "Rizzini", "RIZZINI USA", "Rock Isand Armory", "Rock River Arms", "Rocket Broadheads", "Rocky Mountain", "Rocky Mountain Hunting Calls", "Rosco Manufacturing", "Rossi", "RS Regulate", "Ruger / Sturm, Ruger & Co.", "Ruger Air Guns", "Rugged Gear", "RUGGED SUPPRESSOR", "Rugged Suppressors", "RUKX GEAR", "RW Minis", "RWS", "S", "S.O.G", "S&W Pepper Spray", "Sabre", "Safariland", "Sako", "SAKO (BERETTA USA)", "Samson", "Samson Manufacturing Corp.", "San Tan Tactical", "SAR Arms", "Savage", "SB Tactical", "SCCY Industries", "Scent Thief", "Scentcrusher", "Scentlok", "Schrade", "Scopecoat", "Scott Archery", "Scout", "SDS Imports", "SDS IMPORTS LLC", "Seal 1", "Seekins Precision", "Sellier & Bellot", "SENCUT", "Sentry", "SGM Tactical", "Shadow Systems", "Shark Coast Tactical", "SHARPS BROS LLC", "Sharps Bros.", "Sheffield", "Shield Arms", "Shield Sights", "Shooter's Choice", "Shooters Choice", "Shooters Ridge", "Shooting Made Easy", "Sierra", "Sierra Bullets", "Sig Sauer", "Sig Sauer Airguns", "Sig Sauer Electro-Optics", "Sightmark", "Sightron", "SilencerCo", "Simmons", "SINTERFIRE INC", "Sionyx", "SKB", "SKB Sports", "Skull Hooker", "Slick Trick", "Slip 2000", "SLIP 2000 (SPS MARKETING)", "Slogan Outdoors", "SME", "SME Products", "Smith & Wesson / S&W", "Smith & Wesson LE", "Smiths Products", "SnapSafe", "SOG", "SOG Knives & Tools", "Sons of Liberty Gun Works", "Southern Bloomer", "Southern Bloomers", "Spartan", "Spartan Camera", "Speer", "Speer Ammo", "Speer Ammunition", "Speer Bullets", "Sphinx", "Spike's Tactical", "Spikes", "SportDog", "Sports Afield", "Spot Hogg", "Springfield Armory", "Spyderco", "Spypoint", "SRM Arms", "Stack-On", "Stag Arms", "Standard Manufacturing", "Standard Mfg", "Starline Brass", "Stars and Stripes Defense Ammunition", "Stealth Cam", "Stealth Operator", "Stealth Operator Holster", "STEEL RIVER KNIVES", "Steiner", "Stern Defense", "Steyr Mannlicher", "Sticky Holsters", "STREAK Ammunition", "Streamlight", "Strike", "Strike Industries", "Striker", "Strongsuit", "STV Technology", "Summit", "SUPPRESS TEC LLC", "Surefire", "Surefire Llc", "SURELOCK (DANSONS US LLC)", "Surgeon", "SW Knives", "Swab-Its", "Swagger", "SWAGGER LLC", "Swhacker", "Sylvan Arms", "SZCO Rite Edge", "SZCO Sawmill", "SZCO Sierra Zulu", "SZCO Steel Stag", "T R Imports", "T.R.U. Ball Archery", "T/C Accessories", "Tac Shield", "TAC VANES", "TacFire", "Tacfire Inc.", "TACSHIELD (MILITARY PROD)", "TacStar", "Tactacam", "Tactica", "Tactical Innovations", "Tactical Solutions", "Tactical Superiority", "Tagua", "Talley", "Talley Manufacturing", "Talon", "TALON ARMAMENT LLC", "TALON Grips Inc", "Tanfoglio", "TangoDown", "Tannerite", "TARA TACTICAL USA", "Target Sports", "Tasco", "Taser", "Taurus", "Taylors and Company", "Techna Clip", "Techna Clips", "TekMat", "TEMPLAR KNIFE", "TEN POINT", "Tenzing", "Tetra", "TEXAS AMMO INC", "The Outdoor Connection", "Thermacell", "Thermold", "Thompson Center", "Thorn Broadheads", "Thril", "THRIL INC", "Tight Spot", "Tikka", "Tikka T3", "TIMBER CREEK OUTDOOR INC", "Timney", "Timney Triggers", "Tinks", "Tippman Arms", "Tipton", "Tisas", "Titan 3D", "TNW Firearms", "TNW FIREARMS INC", "Tokarev", "Tokarev Shotguns", "TOOLMAN TACTICAL, INC", "Top Brass", "TOP BRASS LLC", "Tornado Personal Defense", "Torrent Suppressors", "TPS Arms", "TR Imports", "TR&Z", "Traditions Performance Firearms", "Trailblazer Firearms", "TRIGGERTECH", "Trijicon", "Trijicon Electro Optics", "Trijicon EO", "TriStar Arms", "Trius", "Trophy Ridge", "Trophy Taker", "Troy Defense", "Troy Ind", "Troy Industries", "Troy Industries Inc", "True Precision", "Trufire", "Truglo", "Truglo Bowfishing", "Tulammo", "Turner Fabrications", "Two Two Three Innovations", "TYPHOON DEFENSE (ARMSCO)", "U.S. OPTICS", "UDAP", "Ulfhednar", "Ultimate Survival Technologies", "Ultradot", "Ultradyne", "Ultradyne USA", "Umarex", "Umarex USA", "Unbranded AR", "Uncle Henry", "Uncle Mike's", "Uncle Mikes", "UNCLE MIKES-LEATHER(1791)", "Underwood Ammo", "Unity Tactical", "US Optics", "US Palm", "US PeaceKeeper", "UST - Ultimate Survival Technologies", "UTAS-USA", "UTG", "UTG Pro", "UTS/PEPPERBALL", "Uzi Accessories", "Vanguard", "VaporTrail", "VELVET ANTLER TECH", "VersaCarry", "Vertx", "Victory Archery", "Viper Archery Products", "Viridian", "Viridian Weapon Technologies", "Walker's", "Walkers", "Walkers Game Ear", "Walther Air Pistol", "Walther Arms", "Warne", "Warne Scope Mounts", "Wasp Archery Products", "WE Knife", "Weatherby Inc", "Weaver", "Weaver Mounts", "Western Rivers", "Wheeler", "Whitetail Institute", "Wicked Ridge", "Wicked Tree Gear", "WILDGAME INNOVATIONS GSM", "Wildlife Research", "Williams Gunsight Co.", "Wilson Combat", "Winchester", "Winchester Ammo", "Winchester Guns", "Winchester Muzzleloading", "Winchester Powder", "Winchester Safes", "Windham Weaponry", "WMD Guns", "Woodhaven Calls", "WOODHAVEN CUSTOM CALLS", "Woox", "WOOX LLC", "Wraithworks", "X-GRIP", "X-VISION", "XPEDITION ARCHERY LLC", "Xpedition Crossbows", "XS Sight Systems", "XS Sights", "Yankee Hill", "Yankee Hill Machine", "Yankee Hill Machine Co", "Zac Brown's Southern Grind", "Zaffiri Precision", "Zap", "Zastava Arms", "Zenith Firearms", "ZEV", "Zev Technologies", "ZRODELTA"];
                                    /*
                                    fetch("https://ffl-api.garidium.com", {
                                        method: "POST",
                                        headers: {
